<x-admin-layout title="Expense Requests">
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted mb-0 small">All submitted expense requests</p>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-12 col-sm-6 col-lg-2 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.expense-requests.index') }}" class="btn btn-sm btn-outline-secondary flex-fill">Reset</a>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <tbody>
                        @forelse($requests as $req)
                            <tr>
                                ...
                                <td class="d-none d-lg-table-cell text-muted small">{{ $req->created_at->format('d M Y') }}</td>
                                <td>
