...
<div class="ef-form-page">
    <div class="ef-form-page-header">
        ...
        <div>
            <h1 class="ef-form-page-heading">New Inventory Category</h1>
            <p class="ef-form-page-sub">Organise inventory items into categories</p>
        </div>
    </div>
            ...
            <div class="ef-form-grid ef-form-grid-1">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="ef-textarea">{{ old('description') }}</textarea>
                </div>
