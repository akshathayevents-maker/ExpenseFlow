...
<div class="ef-form-page">
    <div class="ef-form-page-header">
        ...
        <div>
            <h1 class="ef-form-page-heading">Edit Vendor</h1>
            <p class="ef-form-page-sub">{{ $vendor->name }}</p>
        </div>
    </div>
            ...
            <div class="ef-form-grid ef-form-grid-2">
                ...
                <div style="grid-column: 1 / -1">
                    ...
                    <textarea id="address" name="address" rows="2"
                              class="ef-textarea @error('address') --error @enderror">{{ old('address', $vendor->address) }}</textarea>
                ...
                <div style="grid-column: 1 / -1">
                    ...
                    <textarea id="notes" name="notes" rows="2"
                              class="ef-textarea @error('notes') --error @enderror">{{ old('notes', $vendor->notes) }}</textarea>
