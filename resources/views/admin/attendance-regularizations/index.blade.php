    ...
    <div class="ar-list">
        ...
        <div class="ar-card">
            ...
            <div class="ar-actions">
                <button type="button" class="ef-btn ef-btn-dark" data-bs-toggle="modal" data-bs-target="#approveArModalA{{ $record->id }}">
                    <i class="bi bi-check-lg"></i> Approve
                </button>
                <button type="button" class="ef-btn" style="color:var(--ef-danger)" data-bs-toggle="modal" data-bs-target="#rejectArModalA{{ $record->id }}">
                    <i class="bi bi-x-lg"></i> Reject
                </button>
            </div>

            <div class="modal fade" id="approveArModalA{{ $record->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="max-width:420px">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{ route('admin.attendance-regularizations.approve', $record) }}">
                            @csrf
                            @method('PATCH')
            ...
            <div class="modal fade" id="rejectArModalA{{ $record->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="max-width:420px">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form method="POST" action="{{ route('admin.attendance-regularizations.reject', $record) }}">
                            @csrf
                            @method('PATCH')
                            <div class="modal-body">
