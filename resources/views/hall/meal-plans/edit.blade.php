...
<div class="ef-mpf-shell">
    ...
    <div class="ef-mpf-card">
        ...
        <div class="ef-mpf-section">
            ...
            {{-- Live preview card --}}
            <div id="livePreview" style="background:rgba(20,20,18,.028);border:1px solid var(--ef-border);border-radius:14px;padding:16px 18px;margin-top:4px">
                ...
                <div style="display:flex;align-items:start;justify-content:space-between;gap:12px;flex-wrap:wrap">
                    <div>
                        <div id="prevName" style="font-size:1.05rem;font-weight:760;color:var(--ef-ink);margin-bottom:3px">{{ $mealPlan->name }}</div>
                        <div id="prevPrice" style="font-size:.88rem;color:var(--ef-emerald);font-weight:640">₹{{ number_format($mealPlan->price_per_person, 0) }} / guest</div>
                    </div>
                    <div style="text-align:right;min-width:140px">
                        ...
                        <div id="prevEstimate" style="font-size:1.15rem;font-weight:760;color:var(--ef-ink);margin-top:6px">₹{{ number_format($mealPlan->price_per_person * 100, 0) }}</div>
                        <div style="font-size:.68rem;color:var(--ef-muted)" id="prevFormula">100 × ₹{{ number_format($mealPlan->price_per_person, 0) }}</div>
                    </div>
                </div>
            </div>
        </div>
