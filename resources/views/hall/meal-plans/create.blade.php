<x-admin-layout title="Add Meal Plan">
@push('styles')
<style>
...
@media (max-width: 767.98px) {
    ...
    .ef-mpf-footer  { padding: 16px 18px; }
    .ef-mpf-cat-guide { grid-template-columns: minmax(0, 1fr); }
...
<div class="ef-mpf-shell">
    ...
    <h1 class="ef-mpf-title">New Meal Plan</h1>
    <p class="ef-mpf-subtitle">Add a catering package to offer guests during hall bookings.</p>
    ...
    <div class="ef-mpf-card">
        <form method="POST" action="{{ route('hall.meal-plans.store') }}">
        @csrf
        ...
        <div class="ef-mpf-section">
            ...
            <div class="ef-mpf-field">
                ...
                <input id="name" type="text" name="name" autocomplete="off"
                       ...
                       value="{{ old('name') }}" placeholder="e.g. Silver Banquet Package" required>
            ...
            <div class="ef-mpf-field">
                ...
                <div class="ef-mpf-cat-guide">
                    <div class="ef-mpf-cat-item">
                        <strong>Standard</strong>
                        Essential catering — buffet, basic service
                    </div>
                    <div class="ef-mpf-cat-item" style="border-color:rgba(180,145,90,.22);background:rgba(180,145,90,.04)">
                        <strong style="color:var(--ef-gold)">Premium</strong>
                        Elevated cuisine, plated courses, full service
                    </div>
                    <div class="ef-mpf-cat-item" style="border-color:rgba(60,140,100,.2);background:rgba(60,140,100,.04)">
                        <strong style="color:#3c8c64">Custom</strong>
                        Bespoke package tailored per event
                    </div>
                </div>
            </div>
            ...
            <div class="ef-mpf-field">
                ...
                <textarea id="description" name="description"
                          ...
                          placeholder="Describe what's included — courses, service style, dietary options…">{{ old('description') }}</textarea>
