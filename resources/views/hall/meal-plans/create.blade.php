...
<div class="page-header d-flex align-items-center gap-2 mb-3">
    ...
    <h5 class="mb-0 fw-bold">Add Meal Plan</h5>
</div>
    ...
    <div class="card-body p-4">
        ...
        @csrf
            ...
            <div class="mb-3">
                ...
                <input type="number" name="price_per_person" step="0.01" min="0" class="form-control rounded-3 @error('price_per_person') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <textarea name="description" rows="3" class="form-control rounded-3">{{ old('description') }}</textarea>
            </div>
