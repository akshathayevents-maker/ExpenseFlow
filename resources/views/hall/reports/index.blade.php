...
.ef-rp-subtitle { color: var(--ef-muted); font-size: .9rem; margin-bottom: 6px; }
.ef-rp-date     { color: var(--ef-faint); font-size: .78rem; font-weight: 640; }
.ef-rp-hero-actions {
...
@media (max-width: 1199.98px) {
    .ef-rp-hero { grid-template-columns: minmax(0, 1fr); }
