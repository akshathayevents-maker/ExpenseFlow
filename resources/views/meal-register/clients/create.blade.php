...
.cr-btn--primary{background:#a0723a;color:#fff;box-shadow:0 2px 8px rgba(160,114,58,.25)}
...
<div class="cr-wrap">
    <div class="cr-page-hdr">
        <a href="{{ route('meal-register.clients.index') }}" class="cr-back"><i class="bi bi-arrow-left"></i> Clients</a>
        <h1 class="cr-page-title">Add Client</h1>
    </div>

    <form method="POST" action="{{ route('meal-register.clients.store') }}">
        @csrf
        <div class="cr-card">
            ...
            <div class="cr-card-body">
                <div class="cr-field">
                    ...
                    <input id="name" name="name" type="text" class="cr-input @error('name') is-invalid @enderror"
                           value="{{ old('name') }}" placeholder="e.g. TCS, Infosys, Wipro" required autofocus>
                ...
                <div class="cr-grid2">
                    <div class="cr-field">
                        ...
                        <input id="contact_person" name="contact_person" type="text"
                               ...
                               value="{{ old('contact_person') }}" placeholder="Coordinator name">
                ...
                <div class="cr-field">
                    ...
                    <textarea id="address" name="address" class="cr-input cr-textarea @error('address') is-invalid @enderror"
                ...
                <div class="cr-field">
                    ...
                    <textarea id="remarks" name="remarks" class="cr-input cr-textarea @error('remarks') is-invalid @enderror"
                              placeholder="Internal notes about this client" style="min-height:60px">{{ old('remarks') }}</textarea>
                    @error('remarks')<div class="cr-err">{{ $message }}</div>@enderror
                </div>
                <div class="cr-btn-row">
                    <button type="submit" class="cr-btn cr-btn--primary"><i class="bi bi-check-lg"></i> Save Client</button>
                    <a href="{{ route('meal-register.clients.index') }}" class="cr-btn cr-btn--cancel">Cancel</a>
                </div>
            </div>
        </div>
    </form>
